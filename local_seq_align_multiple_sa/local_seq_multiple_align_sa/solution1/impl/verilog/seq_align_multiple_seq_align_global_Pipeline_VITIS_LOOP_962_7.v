...
module seq_align_multiple_seq_align_global_Pipeline_VITIS_LOOP_962_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln962_fu_348_p2;
reg    ap_block_state1_pp0_stage0_iter0;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    reference_string_comp_0_TDATA_blk_n;
wire   [63:0] zext_ln964_fu_370_p1;
reg   [10:0] i_fu_106;
wire   [10:0] add_ln962_fu_354_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_i_3;
wire   [3:0] trunc_ln964_fu_390_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_530)) begin
        if ((icmp_ln962_fu_348_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0)))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (icmp_ln962_fu_348_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd10) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd11) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd12) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd13) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd14) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd15) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd1) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd2) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd3) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd4) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd5) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd6) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd7) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd8) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd9) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (trunc_ln964_fu_390_p1 == 4'd0) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (icmp_ln962_fu_348_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln962_fu_354_p2 = (ap_sig_allocacmp_i_3 + 11'd1);

assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0)));
end

always @ (*) begin
    ap_condition_530 = (~((ap_start_int == 1'b0) | ((icmp_ln962_fu_348_p2 == 1'd0) & (reference_string_comp_0_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1));
end

assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage0;

assign icmp_ln962_fu_348_p2 = ((ap_sig_allocacmp_i_3 == 11'd1024) ? 1'b1 : 1'b0);

assign local_reference_10_address0 = zext_ln964_fu_370_p1;

assign local_reference_10_d0 = reference_string_comp_0_TDATA;

assign local_reference_11_address0 = zext_ln964_fu_370_p1;

assign local_reference_11_d0 = reference_string_comp_0_TDATA;

assign local_reference_12_address0 = zext_ln964_fu_370_p1;

assign local_reference_12_d0 = reference_string_comp_0_TDATA;

assign local_reference_13_address0 = zext_ln964_fu_370_p1;

assign local_reference_13_d0 = reference_string_comp_0_TDATA;

assign local_reference_14_address0 = zext_ln964_fu_370_p1;

assign local_reference_14_d0 = reference_string_comp_0_TDATA;

assign local_reference_15_address0 = zext_ln964_fu_370_p1;

assign local_reference_15_d0 = reference_string_comp_0_TDATA;

assign local_reference_1_address0 = zext_ln964_fu_370_p1;

assign local_reference_1_d0 = reference_string_comp_0_TDATA;

assign local_reference_2_address0 = zext_ln964_fu_370_p1;

assign local_reference_2_d0 = reference_string_comp_0_TDATA;

assign local_reference_3_address0 = zext_ln964_fu_370_p1;

assign local_reference_3_d0 = reference_string_comp_0_TDATA;

assign local_reference_4_address0 = zext_ln964_fu_370_p1;

assign local_reference_4_d0 = reference_string_comp_0_TDATA;

assign local_reference_5_address0 = zext_ln964_fu_370_p1;

assign local_reference_5_d0 = reference_string_comp_0_TDATA;

assign local_reference_6_address0 = zext_ln964_fu_370_p1;

assign local_reference_6_d0 = reference_string_comp_0_TDATA;

assign local_reference_7_address0 = zext_ln964_fu_370_p1;

assign local_reference_7_d0 = reference_string_comp_0_TDATA;

assign local_reference_8_address0 = zext_ln964_fu_370_p1;

assign local_reference_8_d0 = reference_string_comp_0_TDATA;

assign local_reference_9_address0 = zext_ln964_fu_370_p1;

assign local_reference_9_d0 = reference_string_comp_0_TDATA;

assign local_reference_address0 = zext_ln964_fu_370_p1;

assign local_reference_d0 = reference_string_comp_0_TDATA;

assign lshr_ln_fu_360_p4 = {{ap_sig_allocacmp_i_3[9:4]}};

assign trunc_ln964_fu_390_p1 = ap_sig_allocacmp_i_3[3:0];

assign zext_ln964_fu_370_p1 = lshr_ln_fu_360_p4;

endmodule //seq_align_multiple_seq_align_global_Pipeline_VITIS_LOOP_962_7
