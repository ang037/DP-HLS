...
entity seq_align_multiple_seq_align_Pipeline_VITIS_LOOP_609_12 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of seq_align_multiple_seq_align_Pipeline_VITIS_LOOP_609_12 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln609_fu_348_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal index_1_fu_100 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln612_fu_418_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal max_1_fu_104 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln612_1_fu_426_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal r_fu_108 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln609_fu_354_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_4_fu_366_p34 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln612_fu_410_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal icmp_ln612_fu_404_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln612_fu_414_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_326_32_1_1_U869 : component seq_align_multiple_mux_326_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln609_fu_348_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    index_1_fu_100 <= select_ln612_fu_418_p3;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    max_1_fu_104 <= select_ln612_1_fu_426_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln609_fu_354_p2 <= std_logic_vector(unsigned(r_fu_108) + unsigned(ap_const_lv6_1));
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln609_fu_348_p2)
    begin
        if (((icmp_ln609_fu_348_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln609_fu_348_p2 <= "1" when (r_fu_108 = ap_const_lv6_20) else "0";
    icmp_ln612_fu_404_p2 <= "1" when (signed(max_1_fu_104) < signed(tmp_4_fu_366_p34)) else "0";
    index_1_out <= index_1_fu_100;

    index_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln609_fu_348_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln609_fu_348_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    max_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln609_fu_348_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln609_fu_348_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    select_ln612_1_fu_426_p3 <= 
        tmp_4_fu_366_p34 when (icmp_ln612_fu_404_p2(0) = '1') else 
        max_1_fu_104;
    select_ln612_fu_418_p3 <= 
        zext_ln612_fu_414_p1 when (icmp_ln612_fu_404_p2(0) = '1') else 
        index_1_fu_100;
    trunc_ln612_fu_410_p1 <= r_fu_108(5 - 1 downto 0);
    zext_ln612_fu_414_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln612_fu_410_p1),32));
end behav;
