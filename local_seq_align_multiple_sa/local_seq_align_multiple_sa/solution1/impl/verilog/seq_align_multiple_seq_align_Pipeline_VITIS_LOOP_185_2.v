...
module seq_align_multiple_seq_align_Pipeline_VITIS_LOOP_185_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln185_fu_56_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] ip_cast_fu_68_p1;
reg   [10:0] ip_fu_30;
wire   [10:0] add_ln185_fu_62_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln185_fu_56_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln185_fu_56_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln185_fu_56_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln185_fu_62_p2 = (ap_sig_allocacmp_ip_1 + 11'd1);
...
assign icmp_ln185_fu_56_p2 = ((ap_sig_allocacmp_ip_1 == 11'd1024) ? 1'b1 : 1'b0);
...
endmodule //seq_align_multiple_seq_align_Pipeline_VITIS_LOOP_185_2
