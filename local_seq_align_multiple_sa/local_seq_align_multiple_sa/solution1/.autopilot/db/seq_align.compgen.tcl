...
set id 737
set name seq_align_multiple_mux_3232_32_1_1
...
set ID 740
set hasByteEnable 0
set MemName seq_align_multiple_seq_align_traceback_V_RAM_AUTO_1R1W
...
set ID 741
set hasByteEnable 0
set MemName seq_align_multiple_seq_align_last_pe_score_RAM_AUTO_1R1W
set CoreName ap_simcore_mem
set PortList { 0 1 }
set DataWd 31
set AddrRange 1024
...
set ID 742
set hasByteEnable 0
set MemName seq_align_multiple_seq_align_local_reference_RAM_1WNR_AUTO_1R1W
set CoreName ap_simcore_mem
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { query_string_comp_0_TDATA { I 8 vector } query_string_comp_0_TVALID { I 1 bit } query_string_comp_0_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { reference_string_comp_0_TDATA { I 8 vector } reference_string_comp_0_TVALID { I 1 bit } reference_string_comp_0_TREADY { O 1 bit } } \
} "
} else {
