...
entity seq_align_multiple_seq_align_multiple_Pipeline_pe1_pe28 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of seq_align_multiple_seq_align_multiple_Pipeline_pe1_pe28 is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln168_2_fu_394_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal trunc_ln168_2_reg_603 : STD_LOGIC_VECTOR (5 downto 0);
    signal trunc_ln168_3_fu_416_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal trunc_ln168_3_reg_608 : STD_LOGIC_VECTOR (3 downto 0);
    signal trunc_ln173_fu_450_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal trunc_ln173_reg_693 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln1649_1_fu_430_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal max_row_value_fu_88 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_row_value_3_fu_537_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_col_value_fu_92 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_col_value_4_fu_548_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_col_value_1_fu_96 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln171_fu_454_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_max_col_value_1_load : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal indvar_flatten88_fu_104 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln168_fu_354_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_sig_allocacmp_indvar_flatten88_load : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal icmp_ln171_fu_372_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln168_1_fu_366_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal p_cast309_mid2_v_fu_398_p4 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_1_fu_494_p18 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    mux_164_9_1_1_U2041 : component seq_align_multiple_mux_164_9_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
    ...
    port map (
        ...
        din16 => trunc_ln168_3_reg_608,
        dout => tmp_1_fu_494_p18);
    ...
    indvar_flatten88_fu_104_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln168_fu_348_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    indvar_flatten88_fu_104 <= add_ln168_fu_354_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_flatten88_fu_104 <= ap_const_lv13_0;
                end if;
            end if; 
        end if;
    end process;

    max_col_value_1_fu_96_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln168_fu_348_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    max_col_value_1_fu_96 <= add_ln171_fu_454_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    max_col_value_1_fu_96 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln168_reg_599 = ap_const_lv1_0))) then
                max_col_value_fu_92 <= max_col_value_4_fu_548_p3;
                max_row_value_fu_88 <= max_row_value_3_fu_537_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln168_fu_348_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                trunc_ln168_2_reg_603 <= trunc_ln168_2_fu_394_p1;
                trunc_ln168_3_reg_608 <= trunc_ln168_3_fu_416_p1;
    ...
    add_ln168_1_fu_366_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_load) + unsigned(ap_const_lv7_1));
    add_ln168_fu_354_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten88_load) + unsigned(ap_const_lv13_1));
    ...
    ap_sig_allocacmp_indvar_flatten88_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, indvar_flatten88_fu_104)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_indvar_flatten88_load <= ap_const_lv13_0;
        else 
            ap_sig_allocacmp_indvar_flatten88_load <= indvar_flatten88_fu_104;
        end if; 
    end process;


    ap_sig_allocacmp_max_col_value_1_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, max_col_value_1_fu_96, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_max_col_value_1_load <= ap_const_lv7_0;
        else 
            ap_sig_allocacmp_max_col_value_1_load <= max_col_value_1_fu_96;
        end if; 
    end process;
    ...
    dp_matrix_V_10_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_11_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_12_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_13_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_14_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_15_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_1_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_2_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_3_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_4_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_5_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_6_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_7_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_8_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_9_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    dp_matrix_V_address0 <= zext_ln1649_1_fu_430_p1(8 - 1 downto 0);
    ...
    icmp_ln1649_fu_531_p2 <= "0" when (tmp_1_fu_494_p18 = ap_const_lv9_0) else "1";
    icmp_ln168_fu_348_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten88_load = ap_const_lv13_1000) else "0";
    icmp_ln171_fu_372_p2 <= "1" when (ap_sig_allocacmp_max_col_value_1_load = ap_const_lv7_40) else "0";
    max_col_value_4_fu_548_p3 <= 
        zext_ln173_fu_545_p1 when (icmp_ln1649_fu_531_p2(0) = '1') else 
        max_col_value_fu_92;
    max_col_value_5_out <= max_col_value_fu_92(8 - 1 downto 0);

    max_col_value_5_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln168_reg_599, ap_block_pp0_stage0_11001)
    begin
    ...
    max_row_value_3_fu_537_p3 <= 
        zext_ln168_fu_491_p1 when (icmp_ln1649_fu_531_p2(0) = '1') else 
        max_row_value_fu_88;
    max_row_value_5_out <= max_row_value_fu_88(6 - 1 downto 0);

    max_row_value_5_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln168_reg_599, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln168_reg_599 = ap_const_lv1_1))) then 
    ...
    p_cast309_mid2_v_fu_398_p4 <= select_ln168_1_fu_386_p3(5 downto 4);
    select_ln168_1_fu_386_p3 <= 
        add_ln168_1_fu_366_p2 when (icmp_ln171_fu_372_p2(0) = '1') else 
        ap_sig_allocacmp_x_load;
    select_ln168_fu_378_p3 <= 
        ap_const_lv7_0 when (icmp_ln171_fu_372_p2(0) = '1') else 
        ap_sig_allocacmp_max_col_value_1_load;
    tmp_s_fu_408_p3 <= (p_cast309_mid2_v_fu_398_p4 & ap_const_lv6_0);
    trunc_ln168_2_fu_394_p1 <= select_ln168_1_fu_386_p3(6 - 1 downto 0);
    trunc_ln168_3_fu_416_p1 <= select_ln168_1_fu_386_p3(4 - 1 downto 0);
    trunc_ln173_fu_450_p1 <= select_ln168_fu_378_p3(6 - 1 downto 0);
    zext_ln1649_1_fu_430_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1649_fu_424_p2),64));
    zext_ln1649_fu_420_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln168_fu_378_p3),8));
    zext_ln168_fu_491_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln168_2_reg_603),32));
