set moduleName seq_align_multiple_Pipeline_pe1_pe28
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {seq_align_multiple_Pipeline_pe1_pe28}
...
set C_modelArgList {
	...
	{ max_col_value_5_out int 8 regular {pointer 1}  }
	{ max_row_value_5_out int 6 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dp_matrix_V", "interface" : "memory", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "max_col_value_5_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "max_row_value_5_out", "interface" : "wire", "bitwidth" : 6, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ max_col_value_5_out sc_out sc_lv 8 signal 16 } 
	{ max_col_value_5_out_ap_vld sc_out sc_logic 1 outvld 16 } 
	{ max_row_value_5_out sc_out sc_lv 6 signal 17 } 
	{ max_row_value_5_out_ap_vld sc_out sc_logic 1 outvld 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_col_value_5_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "max_col_value_5_out", "role": "default" }} , 
 	...
 	{ "name": "max_row_value_5_out", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "max_row_value_5_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "seq_align_multiple_Pipeline_pe1_pe28",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_164_9_1_1_U2041", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	seq_align_multiple_Pipeline_pe1_pe28 {
		...
		max_col_value_5_out {Type O LastRead -1 FirstWrite 1}
		max_row_value_5_out {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	...
	max_col_value_5_out { ap_vld {  { max_col_value_5_out out_data 1 8 }  { max_col_value_5_out_ap_vld out_vld 1 1 } } }
	max_row_value_5_out { ap_vld {  { max_row_value_5_out out_data 1 6 }  { max_row_value_5_out_ap_vld out_vld 1 1 } } }
}
