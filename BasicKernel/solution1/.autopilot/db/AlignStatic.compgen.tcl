...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler seq_align_multiple_static_AlignStatic_init_col_score_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler seq_align_multiple_static_AlignStatic_tbp_matrix_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler seq_align_multiple_static_AlignStatic_local_init_col_score_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler seq_align_multiple_static_AlignStatic_local_init_col_score_2_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler seq_align_multiple_static_AlignStatic_preserved_row_buffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_query_length \
    op interface \
    ports { query_length { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 870 \
    name penalties_mismatch_val \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_penalties_mismatch_val \
    op interface \
    ports { penalties_mismatch_val { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 871 \
    name penalties_match_val \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_penalties_match_val \
    op interface \
    ports { penalties_match_val { I 16 vector } } \
} "
}
