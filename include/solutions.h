                            ...
                            map<string, string> &alignments)
{
    ...
    maxVal = score_mat[0][MAX_QUERY_LENGTH-1][MAX_REFERENCE_LENGTH-1];
    maxPos = {MAX_QUERY_LENGTH-1, MAX_REFERENCE_LENGTH-1};
    for (int j = MAX_QUERY_LENGTH-1; j >= 0; j--) {
        if (score_mat[0][j][MAX_REFERENCE_LENGTH-1] > maxVal) {
            maxVal = score_mat[0][j][MAX_REFERENCE_LENGTH-1];
            maxPos = {j, MAX_REFERENCE_LENGTH-1};
        }
    }
    int i = maxPos.first;
    int j = maxPos.second;
                            ...
                            map<string, string> &alignments)
{
    ...
    maxVal = score_mat[0][MAX_QUERY_LENGTH-1][MAX_REFERENCE_LENGTH-1];
    maxPos = {MAX_QUERY_LENGTH-1, MAX_REFERENCE_LENGTH-1};
    for (int i = MAX_REFERENCE_LENGTH-1; i >= 0; i--) {
        if (score_mat[0][MAX_QUERY_LENGTH-1][i] > maxVal) {
            maxVal = score_mat[0][MAX_QUERY_LENGTH-1][i];
            maxPos = {MAX_QUERY_LENGTH-1, i};
        }
    }
    int i = maxPos.first;
    int j = maxPos.second;
                            ...
                            map<string, string> &alignments)
{
    ...
    float maxVal = score_mat[0][MAX_QUERY_LENGTH-1][0];
    std::pair<int, int> maxPos = {MAX_QUERY_LENGTH-1, 0};
                            ...
                            map<string, string> &alignments)
{
    ...
    float maxVal = score_mat[0][MAX_QUERY_LENGTH-1][MAX_REFERENCE_LENGTH-1];
    std::pair<int, int> maxPos = {MAX_QUERY_LENGTH-1, MAX_REFERENCE_LENGTH-1};
